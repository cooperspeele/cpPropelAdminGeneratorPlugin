 ...
 */
class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorConfiguration extends cpPropelAdminModelGeneratorConfiguration
{
<?php include dirname(__FILE__).'/actionsConfiguration.php' ?>

<?php include dirname(__FILE__).'/fieldsConfiguration.php' ?>

<?php include dirname(__FILE__).'/dataTableConfiguration.php' ?>
  /**
